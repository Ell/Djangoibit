...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Show.songfile_length'
        db.alter_column('cms_show', 'songfile_length', self.gf('django.db.models.fields.TimeField')())
    def backwards(self, orm):

        # Changing field 'Show.songfile_length'
        db.alter_column('cms_show', 'songfile_length', self.gf('django.db.models.fields.PositiveIntegerField')())
    models = {
        'cms.grouping': {
        ...
        'cms.show': {
            ...
            'songfile_length': ('django.db.models.fields.TimeField', [], {}),
